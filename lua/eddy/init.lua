...
function M.setup(config)
  ...
  set_highlight("PmenuMatch", { fg = palette.fg_bright, bg = palette.bg_highlight, bold = true })
  set_highlight("PmenuMatchSel", { fg = palette.fg_bright, bg = palette.orange, bold = true })
