  ...
  theme = {
    oxbow = {
      ...
      palette    = {
        ...
        red          = "#cc9488", -- errors, removals
        orchid       = "#b78fa8", -- keywords, control flow
...
function M.setup(config)
  ...
  set_highlight("Conditional", { fg = palette.orchid })
  ...
  set_highlight("markdownCode", { fg = palette.fg })
  set_highlight("markdownH1", { fg = palette.fg, bold = true })
  ...
  link_highlight("@markup.heading.2", "markdownH1")
  link_highlight("@markup.heading.3", "markdownH1")
  link_highlight("@markup.heading.4", "markdownH1")
  link_highlight("@markup.heading.5", "markdownH1")
  link_highlight("@markup.heading.6", "markdownH1")
