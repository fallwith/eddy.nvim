  ...
  theme = {
    oxbow = {
      ...
      palette    = {
        ...
        mauve        = "#ab9a98", -- keywords, control flow
...
function M.setup(config)
  ...
  set_highlight("Conditional", { fg = palette.mauve })
